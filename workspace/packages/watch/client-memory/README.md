...
- `@deepwatch/dsh-client-memory`
- `@deepwatch/dsh-client-memory/client`
- `@deepwatch/dsh-client-memory/components`
- `@deepwatch/dsh-client-memory/memory-mode`
...
```sh
npm install @deepwatch/dsh-client-memory
```
