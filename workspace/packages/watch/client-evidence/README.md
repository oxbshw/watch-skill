...
- `@deepwatch/dsh-client-evidence`
- `@deepwatch/dsh-client-evidence/client`
- `@deepwatch/dsh-client-evidence/compare`
- `@deepwatch/dsh-client-evidence/compare-engine`
- `@deepwatch/dsh-client-evidence/compare-mode`
...
```sh
npm install @deepwatch/dsh-client-evidence
```
...
Mounted as a profile row. In your profile's `cordis.patch.yml`:
