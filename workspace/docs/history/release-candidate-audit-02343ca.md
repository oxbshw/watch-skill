# Historical release candidate audit — commit `02343ca`

> **Immutable historical record.** This file is not current release evidence,
> is excluded from current-status navigation, and must not be used to describe
> a later candidate. Current evidence is generated by the exact-head CI jobs,
> packed-artifact inventory, screenshot manifest, and release manifest.
