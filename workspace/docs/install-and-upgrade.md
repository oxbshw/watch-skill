...
> actually published right now, the badges at the top of the
> [README](../../README.md) read the registries directly; this page is written
> from the release, not from a poll of the service.
