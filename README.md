...
Available as Claude Code skills, 28 MCP tools, a CLI, a REST API, and native adapters for
...
MCP gives an agent 28 tools. Skills give it the judgement about when to use them —
...
is worth watching, MCP carries the 28 tools. Installing both is the full setup, and
...
| [Tool reference](docs/tools/README.md) | All 28 MCP tools and their REST/CLI counterparts |
