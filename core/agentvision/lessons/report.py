...
from agentvision.lessons.classify import classify_content_type, classify_error, derive_guidance
...
def report_mistake(
    ...
    *,
    ...
    from agentvision.lessons.profiles import update_profiles  # noqa: PLC0415
