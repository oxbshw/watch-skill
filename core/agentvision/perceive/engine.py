...
from agentvision.perceive import budget as budget_mod
from agentvision.perceive import media, ocr, scenes
from agentvision.perceive.types import Frame, PerceptionResult, VideoMetadata
...
def _run_ocr(frames: list[Frame], lang: str | None = None) -> None:
    ...
    for i, frame in enumerate(frames):
        try:
            ...
            print(f"[agentvision] OCR failed on frame {i}: {exc}", file=sys.stderr)
