...
DELIBERATE: dict[tuple[str, str], str] = {
    ...
    ("workspace/tests/execution-observation.test.mjs", "github token"):
        "the same fixture set, for the token shape a redactor is most often asked "
        "about and most often misses",
